        ...
        <div className="lg:text-center mb-[50px] mt-[50px] space-y-[100px]">
          ...
          <div className="space-y-[100px]">
            <ModalImageComponent
              ...
              items={[
                "Displays know your location.",
                "Click Allow button to know user location",
              ]}
              url={"https://gcdn.pbrd.co/images/zQUQRowgqOCM.png?o=1"}
            />
            <ModalImageComponent
              title={"Terms and Condition"}
              items={["Click Kondisyon, to open the Terms and Conditions."]}
              url={"https://gcdn.pbrd.co/images/3xnRSw3o48FC.png?o=1"}
            />
            <ModalImageComponent
              //   title={"Agree on the Terms and Conditions"}
              items={[
                "Agree on the Terms and Conditions by clicking the checkbox.",
                "Close the Term and Conditions window by clicking the close button",
              ]}
              url={"https://gcdn.pbrd.co/images/G3nrigczD0nP.png?o=1"}
            />
          </div>
        </div>
      </div>
